...
class TestTotalEarningsDONOTBuyHouse {
	...
	private final RentalStream streamRentJohn = new RentalStream("RentJohn", LocalDate.of(2022, 5, 1),LocalDate.of(2100, 1, 1), 4900.0, 0.026);
	...
	private final RentalStream streamRentLynne = new RentalStream("RentLynne", LocalDate.of(2022, 5, 1),LocalDate.of(2100, 1, 1), 4900.0, 0.026);
