...
class TestTotalEarningsLowInflation {
	...
	private final PensionAccount accAvivaJohn = new PensionAccount("Aviva_John",104250.0, 0.025);
	private final PensionAccount accPruLynne = new PensionAccount("Pru_Lynne",22512.0,0.025);
	private final TaxedAccount accLumpJohn = new TaxedAccount("Av_JH_notax",34750.0,0.025);
	...
	private final IncomeStream streamLGPSPenLynne = new IncomeStream("LGPSPension",LocalDate.of(2031,4,17),LocalDate.of(2100,1,1),10283.15,0.023,true,false,false);
	...
	private final IncomeStream streamStatePenJohn = new IncomeStream("StateJohn",LocalDate.of(2035,4,23),LocalDate.of(2100,1,1),12014.0,0.025,true,false,false);
	private final IncomeStream streamStatePenLynne = new IncomeStream("StateLynne",LocalDate.of(2035,11,14),LocalDate.of(2100,1,1),12014.0,0.025,true,false,false);
	...
	private final IncomeStream streamSalLynne = new IncomeStream("SalaryLynne",LocalDate.of(1986,6,9),LocalDate.of(2026,4,17),39000.0,0.01,true,true,true);
