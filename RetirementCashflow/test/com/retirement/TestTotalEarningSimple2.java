...
class TestTotalEarningSimple2 {
	...
	private final PensionStream streamWorkPen1John = new PensionStream("*RRPension 1", LocalDate.of(2025,4,5),LocalDate.of(2100, 1, 1), 100.0, 0.0);
	...
	void test() {
		...
		try {
			assertEquals(2987.5, cashFlow.getResidual(LocalDate.of(2058, 12, 31)), 0.1);
