...
class TestWithdrawFromAppropriate {
	...
	private final TaxedAccount acc3 = new TaxedAccount("Taxed",51000.0,0.04);
	...
	private final ISAaccount acc6 = new ISAaccount("ISA",49000.0,0.01);
	private final PremBondsAccount acc7 = new PremBondsAccount("prems",51000.0,0.035);
